...
contract PayrollKit is KitBase {
    ...
    function addEmployees(Payroll payroll, address root) internal {
        ...
        payroll.addEmployee(this, salary1, 'protofire.aragonid.eth', 'Organization', uint64(now));
        payroll.addEmployee(account2, salary2, 'leolower.protofire.eth', 'Project Manager', uint64(now- 86400));
        payroll.addEmployee(account3, salary3, 'lmcorbalan.protofire.eth', 'Developer',  uint64(now - 172800));
    }
}
