module.exports = (artifacts, web3) => {
  ...
  async function createPayrollAndPriceFeed(dao, payrollBase, owner, currentTimestamp) {
    ...
    const MODIFY_PRICE_FEED_SETTINGS_ROLE = await payroll.MODIFY_PRICE_FEED_SETTINGS_ROLE()
    ...
    await acl.createPermission(owner, payroll.address, MODIFY_PRICE_FEED_SETTINGS_ROLE, owner, { from: owner })
