...
contract DevTemplate {
    ...
    function apmInit(address votingBase, bytes votingContentURI, address vaultBase, bytes vaultContentURI, address tokenManagerBase, bytes tokenManagerContentURI) {
