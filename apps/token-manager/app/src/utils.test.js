...
test('Items having the same value should have an equal percentage, if divisible', () => {
...
describe('Percentages should be adjusted to reach 100%', () => {
  test('Stakes: 100, 100, 100, 11, 2', () => {
