The Voting app is used to create and vote on proposals. Votes can be linked to an action, such as issuing a new token or transfering funds, or be purely informative.
