...
class VotingDeployer {
  ...
  async deploy(options = {}) {
    ...
    const restrictedPermissions = ['SET_AGREEMENT_ROLE', 'MODIFY_SUPPORT_ROLE', 'MODIFY_QUORUM_ROLE', 'MODIFY_OVERRULE_WINDOW_ROLE', 'MODIFY_EXECUTION_DELAY_ROLE', 'MODIFY_QUIET_ENDING_ROLE']
