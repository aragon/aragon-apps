...
const ENS = artifacts.require('@conflux-/aragon-os/contracts/lib/ens/ENS')
const MiniMeToken = artifacts.require('@conflux-/aragon-os/contracts/lib/minime/MiniMeToken')
const MiniMeTokenFactory = artifacts.require('@conflux-/aragon-os/contracts/lib/minime/MiniMeTokenFactory')
const PublicResolver = artifacts.require('@conflux-/aragon-os/contracts/lib/ens/PublicResolver')
const Repo = artifacts.require('@conflux-/aragon-os/contracts/apm/Repo')

const SurveyKit = artifacts.require('@aragon/kits-survey/contracts/SurveyKit')
const Survey = artifacts.require('@conflux-/aragon-apps-survey/contracts/Survey')
