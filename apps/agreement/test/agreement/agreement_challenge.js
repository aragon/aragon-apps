              ...
              context('when the challenger has approved the arbitrator fees', () => {
                ...
                context('when the disputable allows the action to be challenged', () => {
                  ...
                  it('creates a challenge', async () => {
                    ...
                    assertBn(challenge.challengerArbitratorFeeAmount, feeAmount, 'arbitrator amount does not match')
                    assert.equal(challenge.challengerArbitratorFeeToken, feeToken, 'arbitrator token does not match')
